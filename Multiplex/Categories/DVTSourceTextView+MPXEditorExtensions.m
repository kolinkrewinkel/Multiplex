...
{
    [self mpx_offsetSelectionsDefaultingLengthsToZero:MPXLeftArrowSelectionOffset modifySelection:modifySelection];
}
...
{
    [self mpx_offsetSelectionsDefaultingLengthsToZero:MPXRightArrowSelectionOffset modifySelection:modifySelection];
}
