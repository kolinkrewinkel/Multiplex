...
{
    id  _buildResultsOutlineDelegate;
    IDEActivityLogSection *_activityLog;
    id  _activityLogObserver;
...
+ (id)sharedTextLayout;
+ (void)initialize;
@property(readonly, nonatomic) id  buildResultsOutlineDelegate; // @synthesize buildResultsOutlineDelegate=_buildResultsOutlineDelegate;
