...
- (id)findLocationFollowing:(id)arg1 backwards:(BOOL)arg2 passingTestForSection:(dispatch_block_t)arg3;
- (id)lastLocationInLog;
- (id)lastIndexPathInSection:(id)arg1 inIndexPath:(id)arg2;
- (id)_iterateStartingWith:(id)arg1 section:(id)arg2 index:(unsigned long long)arg3 backwards:(BOOL)arg4 level:(long long)arg5 messageCount:(unsigned long long)arg6 onRefPath:(BOOL)arg7 passingTest:(dispatch_block_t)arg8;
