...
- (void)batchUpdateWithBlock:(dispatch_block_t)arg1;
...
- (void)enumerateDataNodesForPersistentObjects:(id)arg1 loadIfNecessary:(BOOL)arg2 usingBlock:(dispatch_block_t)arg3;
- (id)arrayOfPersistentObjectsFromDataNodesPassingTest:(dispatch_block_t)arg1;
- (void)_addPersistentObjectForNode:(id)arg1 toArray:(id)arg2 ifPassingTest:(dispatch_block_t)arg3;
...
@property(retain, nonatomic) id  rootAdapter;
