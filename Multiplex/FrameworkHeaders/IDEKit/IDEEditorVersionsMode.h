...
@interface IDEEditorVersionsMode : IDEEditorModeViewController
{
    ...
    dispatch_block_t _editorCustomizationBlock;
...
@property(copy) dispatch_block_t editorCustomizationBlock; // @synthesize editorCustomizationBlock=_editorCustomizationBlock;
- (void)discardEditing;
