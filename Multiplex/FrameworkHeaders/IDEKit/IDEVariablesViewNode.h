...
@property(readonly) id  dataValue; // @synthesize dataValue=_dataValue;
- (void)primitiveInvalidate;
- (void)_cancelObservers;
- (long long)compareType:(id)arg1;
- (id)pasteboardPropertyListForType:(id)arg1;
- (id)writableTypesForPasteboard:(id)arg1;
- (void)_doWorkThatRequiresFilteredChildrenRecalculation:(dispatch_block_t)arg1;
- (void)_ensureChildrenAreValid:(dispatch_block_t)arg1;
- (void)recursivleyRestoreExpansionStateAndLoadChildrenUsingContextState:(id)arg1 completionHandler:(dispatch_block_t)arg2;
