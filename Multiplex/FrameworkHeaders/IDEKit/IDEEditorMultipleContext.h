...
@property(retain, nonatomic) id  editorContextDelegate; // @synthesize editorContextDelegate=_editorContextDelegate;
...
- (void)_setEditorContextProperties:(id)arg1 selectedProperty:(id)arg2 geometry:(id)arg3 propertySetterBlock:(dispatch_block_t)arg4;
- (BOOL)_getEditorContextProperties:(id *)arg1 selectedProperty:(id *)arg2 geometry:(id *)arg3 propertyGetterBlock:(dispatch_block_t)arg4;
