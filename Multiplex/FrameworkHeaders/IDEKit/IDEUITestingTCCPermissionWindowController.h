...
@interface IDEUITestingTCCPermissionWindowController : NSWindowController
{
    BOOL _isPresenting;
    BOOL _status;
    dispatch_block_t _permissionReplyBlock;
...
@property(copy) dispatch_block_t permissionReplyBlock; // @synthesize permissionReplyBlock=_permissionReplyBlock;
...
- (void)presentInWorkspaceWindowController:(id)arg1 reply:(dispatch_block_t)arg2;
- (id)init;
