...
+ (void)_openNavigationHUDSelection:(id)arg1 forWorkspaceDocument:(id)arg2 documentURL:(id)arg3 usingBlock:(dispatch_block_t)arg4;
...
+ (void)_doOpenWithWorkspaceTabController:(id)arg1 editorContext:(id)arg2 target:(int)arg3 allowFallback:(BOOL)arg4 documentURL:(id)arg5 usingBlock:(dispatch_block_t)arg6;
+ (void)_doOpenIn_SeparateWindow_withWorkspaceTabController:(id)arg1 documentURL:(id)arg2 usingBlock:(dispatch_block_t)arg3;
+ (void)_doOpenIn_NewWindow_withWorkspaceTabController:(id)arg1 documentURL:(id)arg2 usingBlock:(dispatch_block_t)arg3;
+ (void)_doOpenIn_SeparateTab_withWorkspaceTabController:(id)arg1 documentURL:(id)arg2 usingBlock:(dispatch_block_t)arg3;
+ (void)_doOpenIn_SeparateEditor_withWorkspaceTabController:(id)arg1 documentURL:(id)arg2 usingBlock:(dispatch_block_t)arg3;
...
+ (void)_doOpenIn_NewTab_withWorkspaceWindowController:(id)arg1 usingBlock:(dispatch_block_t)arg2;
+ (void)_doOpenIn_NewEditor_withWorkspaceTabController:(id)arg1 usingBlock:(dispatch_block_t)arg2;
+ (void)_doOpenIn_AdjacentEditor_withWorkspaceTabController:(id)arg1 editorContext:(id)arg2 documentURL:(id)arg3 usingBlock:(dispatch_block_t)arg4;
+ (void)_doOpenIn_Ask_withWorkspaceTabController:(id)arg1 editorContext:(id)arg2 documentURL:(id)arg3 initialSelection:(id)arg4 options:(id)arg5 usingBlock:(dispatch_block_t)arg6;
