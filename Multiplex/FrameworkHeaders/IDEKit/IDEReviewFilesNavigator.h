...
@interface IDEReviewFilesNavigator : IDENavigator
{
    ...
    id  _workspaceDataSource;
    id  _fileSystemDataSource;
    id  _flatDataSource;
    id  _issueDataSource;
    int _activity;
...
@property(retain) id  issueDataSource; // @synthesize issueDataSource=_issueDataSource;
@property(retain) id  flatDataSource; // @synthesize flatDataSource=_flatDataSource;
@property(retain) id  fileSystemDataSource; // @synthesize fileSystemDataSource=_fileSystemDataSource;
@property(retain) id  workspaceDataSource; // @synthesize workspaceDataSource=_workspaceDataSource;
