...
@property(readonly, nonatomic) NSObject *queryProvider; // @synthesize queryProvider=_queryProvider;
@property(retain, nonatomic) NSObject *delegate; // @synthesize delegate=_delegate;
...
- (void)findSpellingStringsContaining:(id)arg1 anchorStart:(BOOL)arg2 anchorEnd:(BOOL)arg3 subsequence:(BOOL)arg4 lowercase:(BOOL)arg5 cancelWhen:(dispatch_block_t)arg6 forEachResult:(dispatch_block_t)arg7;
- (void)findFilenameStringsContaining:(id)arg1 anchorStart:(BOOL)arg2 anchorEnd:(BOOL)arg3 subsequence:(BOOL)arg4 lowercase:(BOOL)arg5 cancelWhen:(dispatch_block_t)arg6 forEachResult:(dispatch_block_t)arg7;
- (void)findStringsContaining:(id)arg1 inStorage:(id)arg2 anchorStart:(BOOL)arg3 anchorEnd:(BOOL)arg4 subsequence:(BOOL)arg5 lowercase:(BOOL)arg6 cancelWhen:(dispatch_block_t)arg7 forEachResult:(dispatch_block_t)arg8;
...
- (void)registerTarget:(id)arg1 byCaller:(id)arg2 outOfDateCallback:(dispatch_block_t)arg3;
