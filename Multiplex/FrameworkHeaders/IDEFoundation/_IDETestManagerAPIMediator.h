...
@class DTXConnection, DVTDisallowFinishToken, DVTObservingToken, IDEConsoleAdaptor, NSArray, NSDateFormatter, NSMutableArray, NSMutableDictionary, NSMutableSet, NSMutableString, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSOutputStream, NSString, NSTimer;
...
@property(retain) NSObject *acceptSource; // @synthesize acceptSource=_acceptSource;
...
@property(retain) NSObject *statusStreamQueue; // @synthesize statusStreamQueue=_statusStreamQueue;
...
@property(retain) id  testBundleProxy; // @synthesize testBundleProxy=_testBundleProxy;
...
- (void)_enqueueDelegateBlock:(dispatch_block_t)arg1;
- (void)_executeDelegateBlockWithNextConsoleChunk:(dispatch_block_t)arg1;
