...
{
    id  _containerGraphObject;
    DVTObservingToken *_containerGraphObjectValidObservationToken;
    dispatch_block_t _skipSubgraphBlock;
    dispatch_block_t _predicateBlock;
    dispatch_block_t _visitorBlock;
...
+ (id)containerQueryWithContainerGraphObject:(id)arg1 predicateBlock:(dispatch_block_t)arg2;
+ (void)traverseContainerGraphRootedInContainerGraphObject:(id)arg1 skipSubgraphBlock:(dispatch_block_t)arg2 visitorBlock:(dispatch_block_t)arg3;
+ (void)initialize;
...
- (id)_initWithContainerGraphObject:(id)arg1 skipSubgraphBlock:(dispatch_block_t)arg2 predicateBlock:(dispatch_block_t)arg3 visitorBlock:(dispatch_block_t)arg4;
- (id)init;
