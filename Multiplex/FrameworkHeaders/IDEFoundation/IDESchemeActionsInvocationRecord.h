...
+ (void)invocationRecordWithLocalActionResultFilePath:(id)arg1 completionBlock:(dispatch_block_t)arg2;
...
@property(readonly, nonatomic) id  updateDelegate; // @synthesize updateDelegate=_updateDelegate;
...
- (void)fetchCodeCoverageAndUpdateRecordWithCompletionBlock:(dispatch_block_t)arg1;
- (void)fetchTestSummariesAndUpdateRecordWithCompletionBlock:(dispatch_block_t)arg1;
- (void)fetchLogsAndUpdateRecordWithCompletionBlock:(dispatch_block_t)arg1;
- (void)updateRecordWithCompletionBlock:(dispatch_block_t)arg1;
...
- (void)updateWithArchiveData:(id)arg1 withCompletionBlock:(dispatch_block_t)arg2;
- (void)updateWithProductData:(id)arg1 withCompletionBlock:(dispatch_block_t)arg2;
- (void)saveWithCompletionBlock:(dispatch_block_t)arg1;
- (void)dealloc;
