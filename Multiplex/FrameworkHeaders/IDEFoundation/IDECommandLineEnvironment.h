...
@interface IDECommandLineEnvironment : NSObject
{
    ...
    IDEContainer *_primaryBlueprintProvider;
    IDEScheme *_scheme;
    NSSet *_blueprints;
...
@property(retain, nonatomic) IDEContainer *primaryBlueprintProvider; // @synthesize primaryBlueprintProvider=_primaryBlueprintProvider;
