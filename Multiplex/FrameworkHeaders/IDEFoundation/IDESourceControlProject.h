...
- (void)writeToFilePath:(id)arg1 completionBlock:(dispatch_block_t)arg2;
- (BOOL)readFromFilePath:(id)arg1 error:(id *)arg2;
- (void)writeToBundleOfWorkspace:(id)arg1 completionBlock:(dispatch_block_t)arg2;
- (void)removeFromBundleOfWorkspace:(id)arg1 withCompletionBlock:(dispatch_block_t)arg2;
