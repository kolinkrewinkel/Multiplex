...
- (id)indexPathForMessageOrSection:(id)arg1 messageOrSectionEqualityTest:(dispatch_block_t)arg2;
...
- (id)enumerateMessagesUsingBlock:(dispatch_block_t)arg1;
- (id)enumerateSubsectionsRecursivelyUsingPreorderBlock:(dispatch_block_t)arg1;
- (void)_enumerateSubsectionsRecursivelyUsingPreorderBlock:(dispatch_block_t)arg1 returningFilteredSections:(id)arg2;
