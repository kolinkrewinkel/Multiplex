...
- (id)exportToFileURL:(id)arg1 completionBlock:(dispatch_block_t)arg2;
- (void)clearAllRevisions;
- (id)revisionsWithStartingRevision:(id)arg1 endingRevision:(id)arg2 limit:(unsigned long long)arg3 branch:(id)arg4 completionBlock:(dispatch_block_t)arg5;
...
- (id)baseRevisionWithCompletionBlock:(dispatch_block_t)arg1;
- (id)headRevisionWithCompletionBlock:(dispatch_block_t)arg1;
