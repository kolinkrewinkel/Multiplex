...
- (void)customDataStore:(id)arg1 removeItemAtFilePath:(id)arg2 completionQueue:(id)arg3 completionBlock:(dispatch_block_t)arg4;
- (void)customDataStore:(id)arg1 moveItemAtFilePath:(id)arg2 toFilePath:(id)arg3 completionQueue:(id)arg4 completionBlock:(dispatch_block_t)arg5;
- (void)customDataStore:(id)arg1 makeFilePathsWritable:(id)arg2 completionQueue:(id)arg3 completionBlock:(dispatch_block_t)arg4;
- (void)_unlockReadOnlyItems:(id)arg1 completionQueue:(id)arg2 completionBlock:(dispatch_block_t)arg3;
...
- (void)_enqueueWorkItem:(dispatch_block_t)arg1;
...
- (void)enumerateUpgradeTasksWithBlock:(dispatch_block_t)arg1;
