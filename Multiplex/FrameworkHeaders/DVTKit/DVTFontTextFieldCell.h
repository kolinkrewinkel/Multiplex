...
@interface DVTFontTextFieldCell : DVTButtonTextFieldCell <NSCoding>
{
    ...
    NSPopover *_popover;
    id  _fontCellDelegate;
}

+ (id)keyPathsForValuesAffectingPointSize;
+ (id)defaultImage;
+ (void)initialize;
@property(retain) id  fontCellDelegate; // @synthesize fontCellDelegate=_fontCellDelegate;
...
- (void)enumerateValuesWithBlock:(dispatch_block_t)arg1;
- (void)transformFontViaBlock:(dispatch_block_t)arg1;
@property double pointSize;
- (void)dvt_setFontRepresentation:(id)arg1;
- (void)dvt_setFontValue:(id)arg1;
- (id)multipleValues;
- (id)controlView;
- (void)enumerateMultipleValues:(dispatch_block_t)arg1;
- (void)dvt_sendAction;
