...
{
    dispatch_block_t _doneButtonClickHandlerBlock;
...
@property(copy) dispatch_block_t doneButtonClickHandlerBlock; // @synthesize doneButtonClickHandlerBlock=_doneButtonClickHandlerBlock;
