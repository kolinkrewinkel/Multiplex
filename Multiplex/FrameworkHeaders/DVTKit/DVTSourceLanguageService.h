...
@interface DVTSourceLanguageService : NSObject <DVTInvalidation>
{
    ...
    id  _delegate;
    dispatch_block_t _contentGenerationCompletionBlock;
    long long _status;
}
...
@property(copy) dispatch_block_t contentGenerationCompletionBlock; // @synthesize contentGenerationCompletionBlock=_contentGenerationCompletionBlock;
