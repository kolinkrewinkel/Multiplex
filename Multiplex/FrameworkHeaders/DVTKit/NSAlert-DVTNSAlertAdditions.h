...
- (void)dvt_beginAlertModalForWindow:(id)arg1 allowSheetOverSheet:(BOOL)arg2 completionHandler:(dispatch_block_t)arg3;
- (void)dvt_beginAlertModalForWindow:(id)arg1 completionHandler:(dispatch_block_t)arg2;
@end
