...
- (id)_popUpButton;
- (id)initWithPopUpButton:(id)arg1 images:(id)arg2 actionBlock:(dispatch_block_t)arg3 setupTeardownBlock:(dispatch_block_t)arg4 itemIdentifier:(id)arg5 window:(id)arg6;
