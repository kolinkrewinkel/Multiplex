...
@interface DVTSourceTextView : DVTCompletingTextView <NSAnimationDelegate, NSLayoutManagerDelegate, DVTSourceTextScrollViewDelegate>
{
    ...
    id  _delayedAnnotationLayoutToken;
...
- (void)tokenizableRangesWithRange:(struct _NSRange)arg1 completionBlock:(dispatch_block_t)arg2;
...
- (void)removeVisualization:(id)arg1 fadeOut:(BOOL)arg2 completionBlock:(dispatch_block_t)arg3;
- (void)addVisualization:(id)arg1 fadeIn:(BOOL)arg2 completionBlock:(dispatch_block_t)arg3;
...
- (void)_enumerateMessageBubbleAnnotationsInSelection:(dispatch_block_t)arg1;
