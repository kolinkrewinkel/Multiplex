...
- (void)dvt_invokeWithAccessToUTF8Bytes:(dispatch_block_t)arg1;
...
- (void)dvt_enumerateWhitespaceSeparatedSubstringsInRange:(struct _NSRange)arg1 usingBlock:(dispatch_block_t)arg2;
- (void)dvt_enumerateOccurrencesOfSubstring:(id)arg1 options:(unsigned long long)arg2 usingBlock:(dispatch_block_t)arg3;
- (id)dvt_md5Hash;
