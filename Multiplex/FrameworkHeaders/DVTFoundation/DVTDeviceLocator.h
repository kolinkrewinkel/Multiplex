...
+ (id)deviceLocator;
+ (void)initialize;
- (void)unpairDevice:(id)arg1 completionHandler:(dispatch_block_t)arg2;
- (void)pairCompanionDevice:(id)arg1 withGizmoDevice:(id)arg2 completionHandler:(dispatch_block_t)arg3;
- (void)deleteDevice:(id)arg1 completionHandler:(dispatch_block_t)arg2;
