...
- (void)recordNumber:(long long)arg1 forKey:(char *)arg2 deresolver:(dispatch_block_t)arg3;
- (void)recordTimeResult:(double)arg1 forKey:(char *)arg2 deresolver:(dispatch_block_t)arg3;
- (void)_logReport;
- (void)dealloc;
