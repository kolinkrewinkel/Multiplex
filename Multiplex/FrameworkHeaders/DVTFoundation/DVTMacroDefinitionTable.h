...
@interface DVTMacroDefinitionTable : NSObject <NSCopying, NSMutableCopying>
{
    ...
    dispatch_block_t _willSetValueBlock;
    dispatch_block_t _didSetValueBlock;
}
...
- (void)enumerateMacroNamesAndValuesUsingBlock:(dispatch_block_t)arg1;
- (void)enumerateValuesForMacroName:(id)arg1 usingBlock:(dispatch_block_t)arg2;
...
@property(copy) dispatch_block_t didSetValueBlock;
@property(copy) dispatch_block_t willSetValueBlock;
