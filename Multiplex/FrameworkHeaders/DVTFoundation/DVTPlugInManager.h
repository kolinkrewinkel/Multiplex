...
@interface DVTPlugInManager : NSObject
{
    ...
    dispatch_block_t _shouldAllowNonApplePlugInsCallback;
}

+ (BOOL)enumerateExtensionDataForPluginAtPath:(id)arg1 error:(id *)arg2 withBlock:(dispatch_block_t)arg3;
+ (BOOL)ib_enumerateExtensionDataForPluginAtPath:(id)arg1 error:(id *)arg2 withBlock:(dispatch_block_t)arg3;
+ (void)_setDefaultPlugInManager:(id)arg1;
+ (id)defaultPlugInManager;
+ (void)initialize;
@property(copy) dispatch_block_t shouldAllowNonApplePlugInsCallback; // @synthesize shouldAllowNonApplePlugInsCallback=_shouldAllowNonApplePlugInsCallback;
...
- (void)_registerDescriptorType:(id)arg1 activationCallback:(dispatch_block_t)arg2;
