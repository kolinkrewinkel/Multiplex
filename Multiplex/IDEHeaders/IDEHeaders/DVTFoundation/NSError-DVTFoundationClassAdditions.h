...
+ (id)dvt_errorWithDomain:(id)arg1 errorCode:(long long)arg2 message:(id)arg3 recoverySuggestion:(id)arg4 recoveryOptions:(id)arg5 andRecoveryBlock:(dispatch_block_t)arg6;
...
- (id)dvt_errorBySettingRecoveryOptions:(id)arg1 andRecoveryBlock:(dispatch_block_t)arg2;
@end
