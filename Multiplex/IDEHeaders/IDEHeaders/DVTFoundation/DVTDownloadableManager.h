...
+ (void)deferActivity:(id)arg1 untilDate:(id)arg2 gracePeriod:(double)arg3 allowBattery:(BOOL)arg4 block:(dispatch_block_t)arg5;
+ (void)initialize;
...
- (void)updateOutdatedDownloadables:(id)arg1 errorHandler:(dispatch_block_t)arg2;
...
- (void)_withWillDidChangeSetMutationNotifications:(id)arg1 kind:(unsigned long long)arg2 change:(id)arg3 withBlock:(dispatch_block_t)arg4;
- (id)_performLockedReturningBlock:(dispatch_block_t)arg1;
