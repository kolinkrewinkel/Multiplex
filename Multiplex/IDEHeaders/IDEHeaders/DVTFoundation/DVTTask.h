...
@interface DVTTask : NSObject
{
    ...
    dispatch_block_t _runLoopSignaler;
...
- (BOOL)launchRunningTerminationHandlerOnQueue:(id)arg1 error:(id *)arg2 terminationHandler:(dispatch_block_t)arg3;
...
- (void)installEventHandlersForChildPID:(int)arg1 queue:(id)arg2 terminationHandler:(dispatch_block_t)arg3;
