...
- (id)nameOfTrackingBranch:(dispatch_block_t)arg1;
- (id)workingTree:(id)arg1 parentBranchesWithCompletionBlock:(dispatch_block_t)arg2;
- (id)repository:(id)arg1 currentRevisionWithCompletionBlock:(dispatch_block_t)arg2;
