...
#import "IDEBuildStatisticsData-Protocol.h"
...
@interface IDEBuildStatisticsSection : NSObject <IDEBuildStatisticsData>
{
    ...
    dispatch_block_t _contentsEmissionBlock;
}

@property(copy) dispatch_block_t contentsEmissionBlock; // @synthesize contentsEmissionBlock=_contentsEmissionBlock;
...
- (id)description;
- (void)emitContentsForAspect:(id)arg1 logLevel:(int)arg2 indentLevel:(unsigned long long)arg3 withBlock:(dispatch_block_t)arg4;
