...
- (void)enumeratePropertyPermutationsWithBlock:(dispatch_block_t)arg1;
- (void)_permuteAlert:(id)arg1 byVaryingProperty:(id)arg2 in:(id)arg3 values:(id)arg4 withBlock:(dispatch_block_t)arg5;
- (id)properties;
