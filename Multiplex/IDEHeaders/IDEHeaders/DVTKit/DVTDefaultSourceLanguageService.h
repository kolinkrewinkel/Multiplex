...
+ (void)enumerateSupportedContextScopesForLanguage:(id)arg1 block:(dispatch_block_t)arg2;
...
- (void)contextJumpForTypeOverCompletionAtLocation:(unsigned long long)arg1 withInsertionText:(id)arg2 typeOverCompletions:(id)arg3 pendingTypeOverCompletion:(id)arg4 completionBlock:(dispatch_block_t)arg5;
...
- (void)_addLandmarkItemsFromItem:(id)arg1 toParent:(id)arg2 matchingType:(dispatch_block_t)arg3 altParent:(id)arg4 matchingAltType:(dispatch_block_t)arg5 visitChildren:(dispatch_block_t)arg6;
- (void)generateLandmarkItemsForParent:(id)arg1 matchingType:(dispatch_block_t)arg2 altParent:(id)arg3 matchingAltType:(dispatch_block_t)arg4;
