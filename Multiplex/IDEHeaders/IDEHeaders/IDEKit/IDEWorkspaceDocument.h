...
@interface IDEWorkspaceDocument : NSDocument <IDEActiveRunContextStoring, IDEWorkspaceDelegate, IDETestManagerUITestingPermissionSheetDelegate, DVTInvalidation, DVTTabbedWindowCreation, DVTStatefulObject, DVTStateRepositoryDelegate, IDEMustCloseOnQuitDocument, IDEPreBuildSavingDelegate>
{
    ...
    dispatch_block_t _upgradeCompletionBlock;
    ...
    IDEUIRecordingManager *_uiRecordingManager;
...
@property(retain) IDEUIRecordingManager *uiRecordingManager; // @synthesize uiRecordingManager=_uiRecordingManager;
...
- (void)performBlockAfterPreBuildSave:(dispatch_block_t)arg1;
...
- (void)saveAsWorkspace:(id)arg1 showAlert:(BOOL)arg2 completionBlock:(dispatch_block_t)arg3;
