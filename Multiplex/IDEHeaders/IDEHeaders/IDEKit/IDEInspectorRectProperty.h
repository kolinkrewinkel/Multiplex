...
- (void)refresh;
- (id)singleRectValueForKeyPath:(id)arg1 state:(long long *)arg2 transformer:(dispatch_block_t)arg3;
...
- (void)applyUserRectFromSender:(id)arg1 byMappingValues:(dispatch_block_t)arg2;
- (double)baseline;
- (id)nibName;
- (void)loadView;
