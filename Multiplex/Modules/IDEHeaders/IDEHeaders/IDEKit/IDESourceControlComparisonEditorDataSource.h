...
#import "IDEWorkspaceComparisonEditorDataSource-Protocol.h"
...
- (id)documentForAncestorDocumentLocation:(id)arg1 completionBlock:(dispatch_block_t)arg2;
...
- (id)_navigableItemsForPrimaryDocumentLocation:(id)arg1 secondaryDocumentLocation:(id)arg2 usingNavigableItemCoordinator:(id)arg3 usingQueue:(id)arg4 forceReload:(BOOL)arg5 completionBlock:(dispatch_block_t)arg6;
- (id)navigableItemsForPrimaryDocumentLocation:(id)arg1 secondaryDocumentLocation:(id)arg2 usingNavigableItemCoordinator:(id)arg3 forceReload:(BOOL)arg4 completionBlock:(dispatch_block_t)arg5;
