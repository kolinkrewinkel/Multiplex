...
@interface IDEEditorDocument : NSDocument <IDEReadOnlyItem, DVTUndoManagerDelegate>
{
    ...
    id  _closeAfterDelayToken;
    dispatch_block_t _filePresenterWriter;
...
- (void)restoreDocumentWindowWithIdentifier:(id)arg1 state:(id)arg2 completionHandler:(dispatch_block_t)arg3;
...
- (void)_setDocumentFileType:(id)arg1 completionBlock:(dispatch_block_t)arg2;
- (void)duplicateDocumentWithFileType:(id)arg1 writableTypes:(id)arg2 completionBlock:(dispatch_block_t)arg3;
- (void)duplicateDocumentWithFileType:(id)arg1 completionBlock:(dispatch_block_t)arg2;
...
- (void)tryCloseAsynchronouslyWithCompletionBlock:(dispatch_block_t)arg1;
- (void)_tryCloseAsynchronouslyToRevert:(BOOL)arg1 withCompletionBlock:(dispatch_block_t)arg2;
- (void)_tryCloseAsynchronouslyToRevert:(BOOL)arg1 promptForUnsavedChanges:(BOOL)arg2 withCompletionBlock:(dispatch_block_t)arg3;
- (void)_canCloseAsynchronouslyToRevert:(BOOL)arg1 promptForUnsavedChanges:(BOOL)arg2 withCompletionBlock:(dispatch_block_t)arg3;
- (void)performActivityWithSynchronousWaiting:(BOOL)arg1 usingBlock:(dispatch_block_t)arg2;
...
- (id)fileURL;
- (void)relinquishPresentedItemToWriter:(dispatch_block_t)arg1;
- (void)_respondToFileChangeOnDiskWithFilePath:(id)arg1;
- (void)saveForOperation:(unsigned long long)arg1 withCompletionHandler:(dispatch_block_t)arg2;
- (void)saveToURL:(id)arg1 ofType:(id)arg2 forSaveOperation:(unsigned long long)arg3 completionHandler:(dispatch_block_t)arg4;
...
- (id)newUndoManager;
- (void)_startUnlockIfNeededForWorkspace:(id)arg1 window:(id)arg2 completionBlock:(dispatch_block_t)arg3;
- (void)_unlockIfNeededCompletionBlock:(dispatch_block_t)arg1;
- (id)init;
- (void)_changeWasRedone:(id)arg1;
- (void)_changeWasUndone:(id)arg1;
- (void)_changeWasDone:(id)arg1;
- (void)savePresentedItemChangesWithCompletionHandler:(dispatch_block_t)arg1;
- (void)autosaveWithImplicitCancellability:(BOOL)arg1 completionHandler:(dispatch_block_t)arg2;
- (void)continueAsynchronousWorkOnMainThreadUsingBlock:(dispatch_block_t)arg1;
- (void)continueActivityUsingBlock:(dispatch_block_t)arg1;
- (void)continueFileAccessUsingBlock:(dispatch_block_t)arg1;
...
- (void)convertToDocumentAtFilePath:(id)arg1 forFileDataType:(id)arg2 completionBlock:(dispatch_block_t)arg3;
