...
+ (void)_enumerateDocumentExtensionsMatchingFileDataType:(id)arg1 withEditorCategories:(id)arg2 matchBlock:(dispatch_block_t)arg3;
...
- (void)container:(id)arg1 attemptToUnlockItems:(id)arg2 workspace:(id)arg3 completionQueue:(id)arg4 completionBlock:(dispatch_block_t)arg5;
...
- (void)moveItemAtFilePathToTrash:(id)arg1 completionBlock:(dispatch_block_t)arg2;
- (BOOL)canMoveItemsAtFilePaths:(id)arg1 toFilePaths:(id)arg2 completionBlockDispatchQueue:(id *)arg3 completionBlock:(dispatch_block_t *)arg4;
- (void)asyncRemoveItemsAtFilePaths:(id)arg1 completionBlock:(dispatch_block_t)arg2;
- (void)_asyncRemoveItemsAtFilePaths:(id)arg1 completionBlock:(dispatch_block_t)arg2;
- (void)willRemoveItemsAtFilePaths:(id)arg1 completionBlock:(dispatch_block_t)arg2;
- (BOOL)canRemoveItemsAtFilePaths:(id)arg1 completionBlockDispatchQueue:(id *)arg2 completionBlock:(dispatch_block_t *)arg3;
...
- (id)_recentWorkspaceDocumentInfosAsyncUpdate:(dispatch_block_t)arg1;
...
- (void)_runOpenPanelWithURLsFromRunningOpenPanel:(id)arg1 completionBlock:(dispatch_block_t)arg2;
- (void)runOpenPanelWithCompletionBlock:(dispatch_block_t)arg1;
- (id)_setupOpenPanel;
- (id)currentDirectory;
...
- (void)saveAllEditorDocumentsAsyncronouslyWithCompletionBlock:(dispatch_block_t)arg1;
- (void)autosaveInPlaceAllEditorDocumentsAsyncronouslyWithCompletionBlock:(dispatch_block_t)arg1;
- (void)_saveEditorDocuments:(id)arg1 forOperation:(unsigned long long)arg2 completionBlock:(dispatch_block_t)arg3;
...
- (void)_printDocumentsWithContentsOfUnprocessedURLs:(id)arg1 settings:(id)arg2 showPrintPanels:(BOOL)arg3 completionHandler:(dispatch_block_t)arg4;
- (void)_printDocumentsWithContentsOfURLs:(id)arg1 settings:(id)arg2 showPrintPanels:(BOOL)arg3 completionHandler:(dispatch_block_t)arg4;
- (void)_openDocumentsWithContentsOfURLs:(id)arg1 presentErrors:(BOOL)arg2 completionHandler:(dispatch_block_t)arg3;
- (id)openDocumentWithContentsOfURL:(id)arg1 display:(BOOL)arg2;
- (void)asyncOpenDocumentsWithContentsOfURLs:(id)arg1 display:(BOOL)arg2 completionHandler:(dispatch_block_t)arg3;
- (id)openDocumentWithContentsOfURL:(id)arg1 display:(BOOL)arg2 error:(id *)arg3;
- (void)openDocumentWithContentsOfURL:(id)arg1 display:(BOOL)arg2 completionHandler:(dispatch_block_t)arg3;
- (void)asyncOpenDocumentLocation:(id)arg1 display:(BOOL)arg2 completionHandler:(dispatch_block_t)arg3;
- (void)_openDocumentsForDocumentLocations:(id)arg1 display:(BOOL)arg2 completionHandler:(dispatch_block_t)arg3;
- (void)_openProjectsPlaygroundsAndWorkspaces:(id)arg1 display:(BOOL)arg2 openedDocuments:(id)arg3 simpleFileDocumentLocations:(id)arg4 completionHandler:(dispatch_block_t)arg5;
- (void)_openProjectsPlaygroundsAndWorkspaces:(id)arg1 display:(BOOL)arg2 completionHandler:(dispatch_block_t)arg3;
...
- (void)_promptToOpenWorkspaceWithCompletionBlock:(dispatch_block_t)arg1;
- (void)_chooseWorkspaceWithCompletionBlock:(dispatch_block_t)arg1;
- (void)_openWrappingContainerDocument:(id)arg1 displayDocument:(BOOL)arg2 completionHandler:(dispatch_block_t)arg3;
- (id)makeDocumentWithContentsOfURL:(id)arg1 ofType:(id)arg2 error:(id *)arg3;
- (void)_openWorkspaceDocumentForWorkspace:(id)arg1 display:(BOOL)arg2 completionHandler:(dispatch_block_t)arg3;
...
- (void)reopenDocumentForURL:(id)arg1 withContentsOfURL:(id)arg2 display:(BOOL)arg3 completionHandler:(dispatch_block_t)arg4;
- (void)asyncSaveUntitledWorkspaceDocument:(id)arg1 forProjectDocument:(id)arg2 completionHandler:(dispatch_block_t)arg3;
