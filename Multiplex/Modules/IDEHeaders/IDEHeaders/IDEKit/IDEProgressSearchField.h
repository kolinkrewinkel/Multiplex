...
#import "DVTFindPatternSearchField-Protocol.h"
...
+ (Class)cellClass;
+ (void)initialize;
@property(retain) id  searchFieldDelegate; // @synthesize searchFieldDelegate=_searchFieldDelegate;
@property(retain) id  commandDelegate; // @synthesize commandDelegate=_commandDelegate;
