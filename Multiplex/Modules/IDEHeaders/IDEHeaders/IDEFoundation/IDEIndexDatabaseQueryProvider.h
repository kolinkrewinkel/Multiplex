...
- (id)allSuperClassesForClass:(id)arg1 cancelWhen:(dispatch_block_t)arg2;
...
- (id)callsForCallable:(id)arg1 cancelWhen:(dispatch_block_t)arg2;
- (id)_allSubClassesForClass:(id)arg1 stoppingAt:(id)arg2 cancelWhen:(dispatch_block_t)arg3;
...
- (id)overriddenSymbolsForCallable:(id)arg1 cancelWhen:(dispatch_block_t)arg2;
...
- (id)classesWithMembers:(id)arg1 andSubclasses:(BOOL)arg2 cancelWhen:(dispatch_block_t)arg3;
...
- (id)allParentsOfSymbols:(id)arg1 cancelWhen:(dispatch_block_t)arg2 forIndex:(id)arg3;
...
- (id)allSymbolsMatchingName:(id)arg1 kind:(id)arg2 cancelWhen:(dispatch_block_t)arg3 forIndex:(id)arg4;
- (unsigned long long)countOfSymbolsMatchingKind:(id)arg1 workspaceOnly:(BOOL)arg2 forIndex:(id)arg3;
- (id)allSymbolsMatchingKind:(id)arg1 workspaceOnly:(BOOL)arg2 cancelWhen:(dispatch_block_t)arg3 forIndex:(id)arg4;
...
- (id)symbolsContaining:(id)arg1 anchorStart:(BOOL)arg2 anchorEnd:(BOOL)arg3 subsequence:(BOOL)arg4 ignoreCase:(BOOL)arg5 cancelWhen:(dispatch_block_t)arg6 forIndex:(id)arg7;
- (id)topLevelProtocolsWorkspaceOnly:(BOOL)arg1 cancelWhen:(dispatch_block_t)arg2 forIndex:(id)arg3;
- (id)topLevelClassesWorkspaceOnly:(BOOL)arg1 cancelWhen:(dispatch_block_t)arg2 forIndex:(id)arg3;
- (id)topLevelSymbolsMatchingKind:(id)arg1 workspaceOnly:(BOOL)arg2 cancelWhen:(dispatch_block_t)arg3 forIndex:(id)arg4;
- (id)filesContaining:(id)arg1 anchorStart:(BOOL)arg2 anchorEnd:(BOOL)arg3 subsequence:(BOOL)arg4 ignoreCase:(BOOL)arg5 cancelWhen:(dispatch_block_t)arg6 forIndex:(id)arg7;
