...
- (id)processedSymbolsInContext:(id)arg1 initFunction:(dispatch_block_t)arg2 visitorFunction:(dispatch_block_t)arg3 includeSymbolLocations:(BOOL)arg4 withCurrentFileContentDictionary:(id)arg5 forIndex:(id)arg6;
...
- (void)performCompletion:(dispatch_block_t)arg1;
- (void)asyncPerformClang:(dispatch_block_t)arg1;
- (void)performClang:(dispatch_block_t)arg1;
