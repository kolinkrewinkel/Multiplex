...
- (void)deletePreferenceSet:(id)arg1 completionQueue:(id)arg2 completionBlock:(dispatch_block_t)arg3;
- (id)duplicatePreferenceSet:(id)arg1 error:(id *)arg2;
- (void)renamePreferenceSet:(id)arg1 toName:(id)arg2 completionQueue:(id)arg3 completionBlock:(dispatch_block_t)arg4;
...
@property(readonly) id  userPreferenceSetsDataStore;
- (id)preferenceSetForName:(id)arg1;
@property(readonly, copy) NSArray *builtInPreferenceSets;
@property(retain) id  currentPreferenceSet;
