...
- (id)runExecutableAtPath:(id)arg1 withArguments:(id)arg2 environment:(id)arg3 options:(id)arg4 terminationHandler:(dispatch_block_t)arg5;
...
- (void)takeScreenshotWithCompletionBlock:(dispatch_block_t)arg1;
@property(readonly) _Bool canTakeScreenshot;
- (void)_syncDeviceCrashLogsDirectoryWithCompletionHandler:(dispatch_block_t)arg1;
- (void)unpair;
...
- (void)purgeResourceWithTag:(id)arg1 bundleIdentifier:(id)arg2 completionBlock:(dispatch_block_t)arg3;
- (void)purgeAllResourcesForBundleIdentifier:(id)arg1 completionBlock:(dispatch_block_t)arg2;
- (void)_resourceControlChannel:(id)arg1 completionBlock:(dispatch_block_t)arg2;
...
- (void)downloadOptimizationProfilesFromBundleIdentifiers:(id)arg1 orPaths:(id)arg2 toFilePath:(id)arg3 completionHandler:(dispatch_block_t)arg4;
- (void)downloadOptimizationProfilesFromBundleIdentifier:(id)arg1 orPaths:(id)arg2 toFilePath:(id)arg3 completionHandler:(dispatch_block_t)arg4;
- (void)downloadOptimizationProfilesFromBundleIdentifier:(id)arg1 orPath:(id)arg2 toFilePath:(id)arg3 completionHandler:(dispatch_block_t)arg4;
- (void)downloadOptimizationProfilesFromPaths:(id)arg1 toFilePath:(id)arg2 completionHandler:(dispatch_block_t)arg3;
...
- (void)requestProcessInformationsOnPairedDevice:(BOOL)arg1 handler:(dispatch_block_t)arg2;
