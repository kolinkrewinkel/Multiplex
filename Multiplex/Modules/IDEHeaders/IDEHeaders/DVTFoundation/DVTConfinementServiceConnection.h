...
@interface DVTConfinementServiceConnection : NSObject
{
    ...
    dispatch_block_t _asyncResponseHandler;
    NSObject *_asyncReceiveQueue;
    dispatch_block_t _asyncReceiveBlock;
...
- (void)startHandlingResponsesAsynchronouslyOnQueue:(id)arg1 handler:(dispatch_block_t)arg2;
...
- (void)_asynchronouslyReceiveDataOfLength:(unsigned long long)arg1 queue:(id)arg2 handler:(dispatch_block_t)arg3;
- (BOOL)sendData:(id)arg1 error:(id *)arg2;
- (void)_asynchronouslySendData:(id)arg1 queue:(id)arg2 handler:(dispatch_block_t)arg3;
